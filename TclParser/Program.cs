...
public class Tokenizer : ITokenizer
{
    ...
    /// Note: If the collected chars buffer is empty, the current char in the reader is consumed!
    /// </summary>
    /// <param name="buffer">A chars buffer, that contains so far collected chars, that will be returned as the Text token.</param>
    /// <param name="whenEmpty">An action, that will be executed, when nothing was executed so far.</param>
